  ...
  return (
    <nav className="flex justify-center items-center py-2 text-4xl bg-accent">
      <div className="flex relative flex-col items-center">
        ...
        <span className="absolute top-16 p-2 text-2xl whitespace-nowrap rounded-lg opacity-0 transition-all delay-50 bg-overlay peer-hover:text-accent peer-hover:opacity-100">
